import '../style/MensagemSobreOAlgoritmo.css'

function MensagemSobreOAlgoritmo(){
  return (
    <div className='mensagemDiv'>
      <h3 className="mensagemH3">
        Ajude o algorítmo a ser mais certeiro
      </h3>
      <br/>
      <p className='mensagemP'>
...
export default MensagemSobreOAlgoritmo